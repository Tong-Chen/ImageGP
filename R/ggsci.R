...
# Copy from https://github.com/nanxstats/ggsci/blob/master/R/palettes.R
# Credits: ggsci
#
...
# 注意把名字里的短线都替换为没有
# "short_name": "ggsci_material_deep-purple",
# "long_name": "ggsci_material_deep-purple",
# "short_name": "ggsci_material_light-blue",
# "long_name": "ggsci_material_light-blue",
# "short_name": "ggsci_material_light-green",
# "long_name": "ggsci_material_light-green",
# "short_name": "ggsci_material_deep-orange",
# "long_name": "ggsci_material_deep-orange",
# "short_name": "ggsci_material_blue-grey",
# "long_name": "ggsci_material_blue-grey",
...
ggsci_db$"bs5"$"blue" <- c(
  "blue100" = "#cfe2ff", "blue200" = "#9ec5fe",
  "blue300" = "#6ea8fe", "blue400" = "#3d8bfd",
  "blue500" = "#0d6efd", "blue600" = "#0a58ca",
  "blue700" = "#084298", "blue800" = "#052c65",
  "blue900" = "#031633"
)
...
ggsci_db$"material"$"deeppurple" <- c(
...
ggsci_db$"material"$"lightgreen" <- c(
...
ggsci_db$"material"$"deeporange" <- c(
...
ggsci_db$"tw3"$"blue" <- c(
  ...
  "blue600" = "#2563eb", "blue700" = "#1d4ed8", "blue800" = "#1e40af",
  "blue900" = "#1e3a8a", "blue950" = "#172554"
)
